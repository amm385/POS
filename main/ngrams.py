...
class Bigram():
	def __init__(self, filename=None, text_string=None, prepared_tokens=None, unk=False, smoothed=NONE):
		if filename:
			with open(filename) as fp:
				self.text = fp.read()
		elif text_string:
			self.text = text_string
		elif prepared_tokens:
	...
	def guess_freq(self, freq_dict,f,max_):
